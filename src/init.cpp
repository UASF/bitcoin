...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bip91", strprintf(_("Enable BIP91 (default: %d)"), DEFAULT_BIP91));
    if (showDebug)
...
bool AppInitParameterInteraction()
{
    ...
    if (!GetBoolArg("-bip91", DEFAULT_BIP91)) {
        UpdateRegtestBIP9Parameters(Consensus::DEPLOYMENT_SEGSIGNAL, 0, 0);
    }
